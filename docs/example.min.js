(function () {
	...
	(function (ICONS) {
	    ...
	    ICONS["triangle"] = "exclamation-triangle";
	})(ICONS || (ICONS = {}));
	var STATUS;
	(function (STATUS) {
	    STATUS["error"] = "error";
	...
	var Notification = {
	    ...
	    view: function (_a) {
	        var attrs = _a.attrs;
	        var status = attrs.status, text = attrs.text, toggle = attrs.toggle;
	        return (mithril("article", { class: "notification notification--" + (status || 'primary') },
	            mithril("i", { class: "fas fa-" + this.icon }),
	            mithril("span", null, text),
	            mithril("a", { href: "javascript:", class: "fas fa-times", onclick: function () {
	                    toggle();
	                    mithril.redraw();
	                } })));
	    }
	...
	var Notifications = {
	    view: function (_a) {
	        var attrs = _a.attrs;
	        var list = attrs.list;
	        var NoteView = Notification;
	        return ([
	            Array.from(list).map(function (note) {
	                return mithril(NoteView, { text: note.text, status: note.status, toggle: function () { return list.delete(note); } });
	            }),
	        ]);
	    }
	};
	    ...
	    view: function () {
	        return (mithril("div", { class: "modal-demo" },
	            mithril("div", { class: "box" },
	                mithril("div", { class: "pa3 ma2" },
	                    mithril("a", { href: "javascript:", onclick: function () { return notes.add(msg(undefined)); }, title: " aufrufen", class: "btn btn--primary-dark" }, "Klick mich f\u00FCr Standard!")),
	                mithril("hr", null),
	                mithril("div", { class: "pa3 ma2" },
	                    mithril("a", { href: "javascript:", onclick: function () { return notes.add(msg(STATUS.success)); }, title: " aufrufen", class: "btn btn--success" }, "Klick mich f\u00FCr Erfolg!")),
	                mithril("hr", null),
	                mithril("div", { class: "pa3 ma2" },
	                    mithril("a", { href: "javascript:", onclick: function () { return notes.add(msg(STATUS.error)); }, title: " aufrufen", class: "btn btn--danger" }, "Klick mich f\u00FCr Fehler!")),
	                mithril("hr", null)),
	            mithril(Notes, { list: notes })));
	    }
	};
